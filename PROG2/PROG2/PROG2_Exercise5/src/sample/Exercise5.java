...
public class Exercise5 extends Application {
	...
	private TableView<Recording> table = new TableView<>(filteredList);
...
SpinnerValueFactory.IntegerSpinnerValueFactory minf = new SpinnerValueFactory.IntegerSpinnerValueFactory(1950, 2010, 1950);
        minYearSpinner.setValueFactory(minf);

        minYearSpinner.setId("minSpinner");
        SpinnerValueFactory.IntegerSpinnerValueFactory maxf = new SpinnerValueFactory.IntegerSpinnerValueFactory(2010, 2020, 2020);
        maxYearSpinner.setValueFactory(maxf);
        minYearSpinner.valueProperty().addListener((observableValue, oldValue, newValue) -> {
            ...
            {
                maxf.setMin(minYearSpinner.getValue());
            }
            maxf.setMin(minYearSpinner.getValue()-1);
        });
        ...
        maxYearSpinner.valueProperty().addListener((observableValue, oldValue, newValue) -> {
            ...
            if(minYearSpinner.getValue()>maxYearSpinner.getValue())
            {
                minf.setMax(maxYearSpinner.getValue());
            }

            minf.setMax(maxYearSpinner.getValue()+1);
        });
