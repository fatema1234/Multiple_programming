...
public class Exercise2 {
	...
	public static void main(String[] args) {
		...
		Searcher sut = new Searcher(new Database().getRecordings());
...
//		Optional<Recording> recordingByName = sut.getRecordingByName(EXISTING_TITLE);
//		if (recordingByName.isEmpty()) {
